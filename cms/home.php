        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-4">
           ...
           <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              <div class="inner">
                <h3><?php echo $conn->query("SELECT * FROM new_parcel")->num_rows; ?></h3>
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              <div class="inner">
                <h3><?php echo $conn->query("SELECT * FROM loading_challan")->num_rows; ?></h3>

                <p>Total Loading Challan </p>
              </div>
              <div class="icon">
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              <div class="inner">
                <h3><?php echo $conn->query("SELECT * FROM unloading_challan")->num_rows; ?></h3>

                <p>Total Unloading Challan </p>
              </div>
              <div class="icon">
                <i class="fa fa-boxes"></i>
              </div>
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="small-box bg-light shadow-sm border">
              <div class="inner">
                <h3><?php echo $conn->query("SELECT * FROM cash_memo")->num_rows; ?></h3>
